#!/bin/bash
#
# Sample code which listens for contents change in a file
# and depending on the new contents trigger an action
#
# (C) 2017 framp at linux-stips-and-tricks dot de
